...
$s = "insert into $tableName values($gb_rel,\'$gb_rel_date\',$numGIs,$numNodes,$numTerms,$nodesWithClusts,$nodesWithClustsSub,$nodesWithSequence,$n_clusts,$n_PI_clusts,$n_singleton_clusts,$n_large_gi_clusts,$n_large_ti_clusts,$n_largest_gi_clust,$n_largest_ti_clust)";
print "$s\n";
$dbh->do("$s");
