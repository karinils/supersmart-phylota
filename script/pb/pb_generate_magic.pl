...
my $cutoffMagicGI = 50000; 	# Stop at the first node that exceeds this number of seqs
my $maxUnclassifiedChildren=100;# Ignore /unclassified/ nodes that have huge numbers of children; these are barcodes!
# ***********************
